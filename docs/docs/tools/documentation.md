...
![Docs command](https://khulnasoft.com/images/mergemate/docs_command.png){width=768}

The tool will generate documentation for all the components that changed in the PR:

![Docs component](https://khulnasoft.com/images/mergemate/docs_components.png){width=768}

![Docs single component](https://khulnasoft.com/images/mergemate/docs_single_component.png){width=768}
