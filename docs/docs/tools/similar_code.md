...
![similar code global](https://khulnasoft.com/images/mergemate/similar_code_global2.png){width=768}


MergeMate will examine the code component and will extract the most relevant keywords to search for similar code:

- `extracted keywords`: the keywords that were extracted from the code by MergeMate. the link will open a search page with the extracted keywords, to allow the user to modify the search if needed.
...
![code search result single](https://khulnasoft.com/images/mergemate/code_search_result_single.png){width=768}


`Organization Search`:

![similar code org](https://khulnasoft.com/images/mergemate/similar_code_org.png){width=768}
...
![analyze similar](https://khulnasoft.com/images/mergemate/analyze_similar.png){width=768}
...
![similar code global](https://khulnasoft.com/images/mergemate/similar_code_global.png){width=768}
