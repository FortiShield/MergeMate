...
This page provides a detailed guide on how to use MergeMate. It includes information on how to adjust MergeMate configurations, define which tools will run automatically, manage mail notifications, and other advanced configurations.
