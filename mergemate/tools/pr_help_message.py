...
from mergemate.git_providers import get_git_provider, GithubProvider
    ...
    async def run(self):
        try:
            ...
            if isinstance(self.git_provider, GithubProvider):
                ...
                pr_comment += "</table>\n\n"
                pr_comment += f"""\n\n(1) Note that each tool be [triggered automatically](https://github.com/Khulnasoft/mergemate/blob/main/Usage.md#github-app-automatic-tools-for-pr-actions) when a new PR is opened, or called manually by [commenting on a PR](https://github.com/Khulnasoft/mergemate/blob/main/Usage.md#online-usage)."""
