...
from mergemate.agent.mergemate import MergeMate, command2class
...
async def _perform_commands_azure(commands_conf: str, agent: MergeMate, api_url: str, log_context: dict):
...
async def handle_webhook(background_tasks: BackgroundTasks, request: Request):
    ...
    if data["eventType"] == "git.pullrequest.created": 
        ...
        await _perform_commands_azure("pr_commands", MergeMate(), pr_url, log_context)
        return
