...
async def _perform_commands_gitlab(commands_conf: str, agent: MergeMate, api_url: str, log_context: dict):
...
async def gitlab_webhook(background_tasks: BackgroundTasks, request: Request):
    ...
    if data.get('object_kind') == 'merge_request' and data['object_attributes'].get('action') in ['open', 'reopen']:
        ...
        await _perform_commands_gitlab("pr_commands", MergeMate(), url, log_context)
